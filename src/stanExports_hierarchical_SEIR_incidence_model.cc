...
#include "stanExports_hierarchical_SEIR_incidence_model.h"

RCPP_MODULE(stan_fit4hierarchical_SEIR_incidence_model_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_hierarchical_SEIR_incidence_model")
